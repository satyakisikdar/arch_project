...
Please double check the default values for the IdealDevice. Remember to properly initialize ```arrayIH->Initialization<>``` and ```arrayHO->Initialization<RealDevice>()``` in main. 
